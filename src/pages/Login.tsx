      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .video-bg {
          ...
          overflow: hidden;
          pointer-events: none;
          background-image: url('https://images.unsplash.com/photo-1490806843957-31f3c0a197d4?auto=format&fit=crop&w=1920&q=90');
        ...
        .video-overlay {
          ...
          inset: 0;
          z-index: 1;
          background: linear-gradient(160deg,rgba(255,247,237,0.70) 0%,rgba(255,251,244,0.60) 50%,rgba(255,245,235,0.68) 100%);
        }
        .left::before {
          content: '';
        ...
        .badge {
          ...
          box-shadow: 0 4px 20px rgba(249,115,22,.12), 0 1px 4px rgba(0,0,0,.04);
        ...
        .blabel { font-size:11.5px; font-weight:600; color:#44403c; line-height:1.25; }
        .bsub   { font-size:10px; color:#a8a29e; }
        .petal {
          position: absolute;
          z-index: 4;
          pointer-events: none;
        ...
        .tagline {
          ...
          text-transform: uppercase; color: #ea580c; margin-bottom: 18px;
        }
        .tagline-bar { width: 26px; height: 2px; border-radius: 2px; background: #ea580c; }
        .headline {
        ...
        .headline em {
          font-style: normal;
          background: linear-gradient(125deg, #f97316 20%, #ea580c 80%);
          -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
        }
        .sub {
          font-size: 14px; color: #57534e; line-height: 1.78;
          max-width: 380px; margin-bottom: 44px; font-weight: 300;
          text-shadow: 0 1px 6px rgba(255,255,255,0.6);
        }
        .fi { display: flex; align-items: flex-start; gap: 14px; margin-bottom: 18px; }
        .fi-icon {
          width: 42px; height: 42px; border-radius: 11px; flex-shrink: 0;
          background: rgba(255,255,255,0.75);
          border: 1px solid rgba(249,115,22,.22);
          box-shadow: 0 2px 10px rgba(249,115,22,.1);
        ...
        .fi:hover .fi-icon {
          ...
          box-shadow: 0 5px 18px rgba(249,115,22,.2);
          transform: translateY(-2px) scale(1.04);
        }
        .fi-title { font-size: 14px; font-weight: 600; color: #1c1917; margin-bottom: 3px; text-shadow: 0 1px 4px rgba(255,255,255,0.5); }
        .fi-desc  { font-size: 12.5px; color: #78716c; font-weight: 300; line-height: 1.6; }
        .lf {
          margin-top: 48px;
        ...
        .r-tag   { font-size: 10px; font-weight: 700; letter-spacing: .13em; color: #ea580c; text-transform: uppercase; margin-bottom: 10px; }
        .r-title { font-family: 'Playfair Display', serif; font-size: 24px; font-weight: 700; color: #1c1917; letter-spacing: -.02em; line-height: 1.2; margin-bottom: 7px; }
        .r-sub   { font-size: 13px; color: #78716c; font-weight: 300; margin-bottom: 28px; }

        .lbl { display: block; font-size: 10px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: #78716c; margin-bottom: 7px; }
        .field-wrap { margin-bottom: 18px; }
        .fi-rel { position: relative; }
        .ficon  { position: absolute; left: 13px; top: 50%; transform: translateY(-50%); width: 15px; height: 15px; color: #c8c4c0; pointer-events: none; }
        .gi {
        ...
        .gi::placeholder { color: #c8c4c0; }
        .gi:focus { border-color: var(--tab-accent, #f97316); box-shadow: 0 0 0 3.5px color-mix(in srgb, var(--tab-accent, #f97316) 15%, transparent); background: #fff; }
        ...
        .sib:hover:not(:disabled)       { transform: translateY(-2px); box-shadow: 0 8px 28px color-mix(in srgb, var(--tab-accent, #f97316) 50%, transparent); }
        .sib:hover:not(:disabled)::after { opacity: 1; }
        .sib:active:not(:disabled)      { transform: translateY(0); }
        ...
        .choose-btn:hover {
          ...
          box-shadow: 0 4px 18px color-mix(in srgb, var(--tab-accent, #f97316) 12%, transparent);
        ...
        .name-card-label { font-size: 10px; text-transform: uppercase; letter-spacing: .1em; color: #a8a29e; margin-bottom: 3px; }
        .name-card-name  { font-size: 14px; font-weight: 700; color: #1c1917; }
        ...
        .divl { height: 1px; background: linear-gradient(to right, transparent, rgba(0,0,0,0.07), transparent); margin: 24px 0; }
        .r-foot { font-size: 10px; letter-spacing: .12em; color: #c8c4c0; text-transform: uppercase; text-align: center; }
