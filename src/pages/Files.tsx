...
import { Upload, Download, Trash2, FolderOpen, FileText, Loader2, Search } from "lucide-react";
        ...
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input 
              ...
              className="pl-11 border-0 bg-muted/30 rounded-xl h-10"
              value={search}
              ...
              {filteredFiles.length === 0 && (
                <TableRow>
                  <TableCell colSpan={5} className="text-center py-12 text-muted-foreground">
                    {search ? `No files found matching "${search}"` : "No files uploaded yet. Click 'Upload Files' to get started."}
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
