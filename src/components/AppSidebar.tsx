import { LayoutDashboard, Users, HardHat, FolderOpen, LogOut, GraduationCap, Clock, CalendarClock, ChevronRight, Flame, History, Link2, UserCheck } from "lucide-react";
...
const otherNav = [
  ...
  { title: "Account Created", url: "/admin/accounts", icon: UserCheck },
